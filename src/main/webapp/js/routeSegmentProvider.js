yuventoryApp.config(function($routeSegmentProvider, $routeProvider) {
    ...
    $routeSegmentProvider.
        ...
        when('/home/reports/stockOutOrLentItems', 'home.reports.stockOutOrLentItems').
        ...
        within().
            ...
            segment('validate', {
                templateUrl : 'items/validate.html'
            }).
            segment('estimate', {
            ...
            within().
                ...
                segment('stockOutOrLentItems', {
                    templateUrl : 'reports/stockOutOrLentItems.html'
                }).
            up().
